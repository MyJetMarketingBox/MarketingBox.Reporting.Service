...
CREATE TEMPORARY TABLE report_by_brand
(
...
CREATE TEMPORARY TABLE aggregate_by_brand
(
    Id                bigint GENERATED BY DEFAULT AS IDENTITY,
    GroupedBy         bigint NOT NULL,
    Name              text,
...
INSERT INTO aggregate_by_brand
(GroupedBy,
 Name,
 BrandId,
 FtdCount,
...
select rd."BrandId" as GroupedBy,
       br."Name" as Name,
       rd."BrandId",
...
INSERT INTO report_by_brand(GroupedBy, Name, FtdCount, RegistrationCount, Revenue, Payout)
select rd.GroupedBy,
       rd.Name,
       sum(rd.FtdCount),
