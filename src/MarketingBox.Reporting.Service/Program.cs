...
using MarketingBox.Reporting.Service.Settings;
...
namespace MarketingBox.Reporting.Service
{
    ...
    {
        public const string SettingsFileName = ".marketingboxreportingservice";
        ...
        {
            Console.Title = "MarketingBox.Reporting.Service";
